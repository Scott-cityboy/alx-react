...
At this point, reloading the App should display the exact same pa2. Handling Events
mandatory
...
Modify the component to make it “pure”. Which means that it will only update when its props and state are differenti
